...
| API Gateway (посетители)| 136312| 1364     | 664 ГБ |

### Нагрузка на хранилища и СУБД

Так как все данные дублируются, общий объём диска умножим на 3, объектное - на 2

| Хранилище       | Объём диска | пиковый RPS | CPU cores | RAM    |
| --------------- | ----------- | ----------- | --------- | ------ |
| ScyllaDB        | 24 ТБ       | 68312       | 683       | 664 ГБ |
| ClickHouse      | 22.5 ТБ     | 68312       | 683       | 664 ГБ |
| Tarantool       | 24 ГБ       | 32          | 1         | 32 ГБ  |
| CEPH            | 4250 ТБ     | 68312       | 683       | 664 ГБ |
