...
| visitors          | id                | 18 Байт  | 91.5 млн. | 1.5 Гб |
| visitor_interests | visitor_id        | 48 Байт  | 4.55 млрд. | 204 Гб |
...
| Tarantool  | Хранение данные о сессиях | Clients | Полностью In-memory | Реплики | 8.5 Гб | 2032 | 1
