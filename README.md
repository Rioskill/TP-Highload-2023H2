...
Будем хранить данные в Kafka в течение минимум недели. Получим 1.5 Тб.
...
| Kafka      | Временное хранение данных перед их записью в ClickHouse| Ad history | Горизонтальное масштабирование за счёт создания нескольких брокеров | Создание Backup'ов | 1.5 Тб | раз в 5 минут | 10416 | 
