...
| Ads                 | 377 Байт            | 4.5 млрд.    | 1.5 Тб       | 70418 | 32 |
| Interests           | 48 Байт             | 1000         | 46.75 Кб     | 70448 | X |
| Ad history          | 50 Байт             | 1.35 млрд.   | 7.5 Тб       | 2032 | 68000 | 
...
| Kafka      | Временное хранение данных перед их записью в ClickHouse| Ad history | Горизонтальное масштабирование за счёт нескольких партиций | - | 1.5 Тб | раз в 5 минут | 10416 | 
...
| ClickHouse | Хранение истории просмотров для создания отчётов, обновления интересов пользователей | Ad history | Шардирование данных | Горячее резервирование | 7.5 Тб | 2032 | раз в 5 минут |
