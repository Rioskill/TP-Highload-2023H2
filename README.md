...
Будем хранить данные в Kafka в течение минимум часа. Получим 600 Мб.
...
| Kafka      | Временное хранение данных перед их записью в ClickHouse| Ad history | Горизонтальное масштабирование за счёт создания нескольких брокеров | Создание Backup'ов | 600 Мб | раз в 5 минут | 10416 | 
